...
enum ResponsiveLayoutSize {
  /// Small layout - Standard for phone screens
  small,

  /// Medium layout - tablets and smaller browser windows
  medium,

  /// Large layout - desktop size
  large
}
...
class ResponsiveLayoutBuilder extends StatelessWidget {
  ...
  /// Optional child widgets builder based on the current layout size
